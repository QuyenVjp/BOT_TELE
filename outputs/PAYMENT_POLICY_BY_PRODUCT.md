...
|---|---|---|
| Digital account/access | VietQR dynamic QR + SePay webhook/check | Owner-requested implementation: SePay verifies/reconciles the bank transaction before delivery. Telegram deployment remains a policy gate; see [risk note](../docs/04-security/TELEGRAM_POLICY_RISK.md). |
