...
| SEC-012 | Critical | Disclosure       | Supplier/account credential appears outside the intended customer Telegram delivery | Vault reference, recipient-bound single-delivery handoff, no raw secret in DB/log/event/webhook, redaction tests, least privilege |
