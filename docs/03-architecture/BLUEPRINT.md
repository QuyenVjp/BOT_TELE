...
Luồng khách hàng và copy màn hình chuẩn nằm tại [MVP Customer Flow](../00-overview/MVP_CUSTOMER_FLOW.md); đặc tả nghiệp vụ nằm tại [FUNCTIONAL_SPEC.md](../02-domain/FUNCTIONAL_SPEC.md).
